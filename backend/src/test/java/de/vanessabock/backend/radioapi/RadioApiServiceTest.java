...
public class RadioApiServiceTest {
    ...
    void getStationsOrderedByVotesTest_WhenCount_ThenReturnListOfCountStations() {
        ...
        //THEN
        assertEquals(List.of(new RadioStation("78012206-1aa1-11e9-a80b-52543be04c81", "MANGORADIO", "https://mangoradio.stream.laut.fm/mangoradio?t302=2024-02-06_03-57-04&uuid=fe4f7927-ca77-4f07-a326-bb2781c5f6dd", "https://mangoradio.de/", ""),
                new RadioStation("962cc6df-0601-11e8-ae97-52543be04c81", "Dance Wave!", "http://stream.dancewave.online:8080/dance.mp3", "https://dancewave.online/", "https://dancewave.online/dw_logo.png")),
                actual);
    }
    ...
    void getStationsBySearchNameTest_WhenCountAndSearch_ThenReturnListOfCountStations() throws NoSuchStationException {
        ...
        //THEN
        assertEquals(List.of(new RadioStation("78012206-1aa1-11e9-a80b-52543be04c81", "MANGORADIO", "https://mangoradio.stream.laut.fm/mangoradio?t302=2024-02-12_04-33-31&uuid=39515d11-8574-4ef1-a652-ad6ec5098a06", "https://mangoradio.de/", ""),
